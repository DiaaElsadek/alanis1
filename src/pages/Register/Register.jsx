...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Common fields for both user types - بالترتيب المطلوب
      ...
      // ✅ DateOfBirth يجب أن يكون string($date-time)
      ...
      if (userType === "user") {
        ...
        // ✅ Provider specific fields - بالترتيب المطلوب
        formDataToSend.append("Bio", formData.bio || "");
        formDataToSend.append("NationalId", formData.nationalId);
        formDataToSend.append("Experience", formData.experience);
        
        // ✅ HourlyRate يجب أن يكون number($double)
        formDataToSend.append("HourlyRate", parseFloat(formData.hourlyRate));
        
        // ✅ IdDocument و Certificate يجب أن يكونا string($binary) - ملفات
        ...
        // ✅ Handle categories - SelectedCategoryIds يجب أن يكون array
        let categoryIds = [];
        ...
        // ✅ إضافة الـ categories كـ array بدون أقواس
        categoryIds.forEach(id => {
          formDataToSend.append("SelectedCategoryIds", id); // بدون parseInt لأن الـ API قد يتوقع string
        });
